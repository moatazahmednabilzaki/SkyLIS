 ...
 */
export async function registerVisit(page: Page): Promise<{ patientName: string }> {
  ...
  await page.locator('.pick', { hasText: tenant.seedTestCode }).locator('input[type="checkbox"]').check();
